...
const Sidebar = (props) => {
  return (
    <>
      ...
      {/* Text Panel */}
      <TextPanelLeft title={props.title || "Websites Development"} button={props.button || "Discover More"}>
        We build responsive and user-friendly websites for businesses and individuals. Our websites are designed to be fast, secure, and easy to use. We also offer website maintenance and support services.
      </TextPanelLeft>
